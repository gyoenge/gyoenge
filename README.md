...
특히 병리 이미지와 유전자 발현 데이터를 다루며 데이터 처리, 구축 및 학습 파이프라인 설계 경험을 쌓고 있습니다.

새로운 도메인을 이해하고, 문제에 적합한 방법론를 설계하며, 데이터 처리 및 모델 학습 파이프라인을 구현하는 과정을 즐깁니다.
<!--새로운 도메인을 이해하고, 특정 문제에 적합한 데이터를 설계하며, 이를 자동화된 파이프라인으로 구현하는 과정을 즐깁니다. -->
<!--AI 기술이 실제 서비스에서 가치를 창출하는 과정에 큰 흥미를 가지고 있으며, 데이터 중심의 AI 시스템 개발 역량을 지속적으로 키워가고 있습니다. -->
